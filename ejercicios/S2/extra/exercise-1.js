...
categories = new Set(); // La clase Set me permite no tener elementos duplicados

for (let movie of movies) {
    /**
     * Los pusheo directamente porque Set se va a encargar de eliminar los duplicados por mi
     */
